...
- [ ] Create `source_registry.csv`, `section_manifest.jsonl`, `weekly_content_manifest.jsonl`, `coverage_matrix.csv` and a publication validator.
- [ ] Create `P01`–`P42`, `PP01`–`PP12`, `PC00`, and `PPD0`–`PPD7` records; distinguish 54 weekly records from 63 total records including special states/overlays.
...
- [ ] Specify draft → reviewed → published → superseded transitions and unpublished-profile UI behavior.
